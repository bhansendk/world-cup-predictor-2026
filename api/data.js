...
const COMPETITION_SLUG = (process.env.COMPETITION_SLUG || 'tirsdagsklubben').toLowerCase().replace(/[^a-z0-9-_]/g, '-');
const BLOB_NAME = process.env.BLOB_DATA_FILE || process.env.BLOB_FILENAME || `wc2026-${COMPETITION_SLUG}.json`;
